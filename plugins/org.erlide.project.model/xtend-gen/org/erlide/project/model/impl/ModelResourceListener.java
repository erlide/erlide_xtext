...
public class ModelResourceListener implements IResourceChangeListener {
  ...
  protected void _updateModel(final IProjectFragment fragment, final IResourceChangeEvent event) {
    Collection<ICodeFolder> _sourceFolders = fragment.getSourceFolders();
    ...
    Collection<ICodeFolder> _includeFolders = fragment.getIncludeFolders();
  ...
  protected void _updateModel(final ICodeFolder folder, final IResourceChangeEvent event) {
    Collection<ICodeUnit> _codeUnits = folder.getCodeUnits();
  ...
  public void updateModel(final IErlangModelElement folder, final IResourceChangeEvent event) {
