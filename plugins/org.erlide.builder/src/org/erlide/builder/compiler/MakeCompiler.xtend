...
public class MakeCompiler extends AbstractCompiler {
    ...
    override compileResource(IFile file, CompilerOptions options, (IFile, String, Integer, Integer)=>void resultsHandler) {
        launchProcess(file, newArrayList("make", file.getName()), new File(
