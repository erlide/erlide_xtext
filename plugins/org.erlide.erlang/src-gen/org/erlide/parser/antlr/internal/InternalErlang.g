...
(
		{ 
	        newCompositeNode(grammarAccess.getDefineAttributeAccess().getMacroNameNAMEVARParserRuleCall_3_0()); 
	    }
		lv_macroName_3_0=ruleNAMEVAR		{
	        if ($current==null) {
...
(
		lv_tag_1_0=	'include' 
    {
        newLeafNode(lv_tag_1_0, grammarAccess.getIncludeAttributeAccess().getTagIncludeKeyword_1_0());
    }
 
	    {
	        if ($current==null) {
       		...
       		setWithLastConsumed($current, "tag", lv_tag_1_0, "include");
	    }
...
(	otherlv_0='-' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getIncludeLibAttributeAccess().getHyphenMinusKeyword_0());
    }
((
(
	'include_lib' 
...
(
		lv_tag_1_0=	'include_lib' 
    {
        newLeafNode(lv_tag_1_0, grammarAccess.getIncludeLibAttributeAccess().getTagInclude_libKeyword_1_0());
    }
 
	    {
	        if ($current==null) {
       		...
       		setWithLastConsumed($current, "tag", lv_tag_1_0, "include_lib");
	    }
...
(
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getIncludeLibAttributeAccess().getRightParenthesisKeyword_4());
    }
this_FULL_STOP_5=RULE_FULL_STOP
    { 
    newLeafNode(this_FULL_STOP_5, grammarAccess.getIncludeLibAttributeAccess().getFULL_STOPTerminalRuleCall_5()); 
    }
)
;
...
(
		{ 
	        newCompositeNode(grammarAccess.getRecordAttributeAccess().getRecordMacroMacroCallParserRuleCall_5_1_0()); 
	    }
		lv_recordMacro_10_0=ruleMacroCall		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getRecordAttributeRule());
	        }
       		set(
...
(	otherlv_0='-' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getCompileAttributeAccess().getHyphenMinusKeyword_0());
    }
((
(
	'compile' 
...
(
		lv_tag_1_0=	'compile' 
    {
        newLeafNode(lv_tag_1_0, grammarAccess.getCompileAttributeAccess().getTagCompileKeyword_1_0());
    }
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getCompileAttributeAccess().getLeftParenthesisKeyword_2());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getCompileAttributeAccess().getOptionsExpressionParserRuleCall_3_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getCompileAttributeAccess().getRightParenthesisKeyword_4());
    }
this_FULL_STOP_5=RULE_FULL_STOP
    { 
    newLeafNode(this_FULL_STOP_5, grammarAccess.getCompileAttributeAccess().getFULL_STOPTerminalRuleCall_5()); 
    }
)
;
...
(	otherlv_7='(' 
    {
    	newLeafNode(otherlv_7, grammarAccess.getExpr700Access().getLeftParenthesisKeyword_1_0_4_0());
    }
((
(
		{ 
	        newCompositeNode(grammarAccess.getExpr700Access().getArgs2ExpressionParserRuleCall_1_0_4_1_0_0()); 
	    }
		lv_args2_8_0=ruleExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getExpr700Rule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_9, grammarAccess.getExpr700Access().getCommaKeyword_1_0_4_1_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getExpr700Access().getArgs2ExpressionParserRuleCall_1_0_4_1_1_1_0()); 
	    }
		lv_args2_10_0=ruleExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getExpr700Rule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_11, grammarAccess.getExpr700Access().getRightParenthesisKeyword_1_0_4_2());
    }
)?)
    |(	otherlv_12='#' 
    {
    	newLeafNode(otherlv_12, grammarAccess.getExpr700Access().getNumberSignKeyword_1_1_0());
    }
(
    {
        $current = forceCreateModelElementAndSet(
...
(
    ...
    { 
        newCompositeNode(grammarAccess.getTermExpressionAccess().getListComprehensionParserRuleCall_1()); 
    }
    this_ListComprehension_1=ruleListComprehension
    { 
        $current = $this_ListComprehension_1.current; 
        afterParserOrEnumRuleCall();
    }
)
    |
    { 
        newCompositeNode(grammarAccess.getTermExpressionAccess().getListParserRuleCall_2()); 
    }
    ...
    { 
        newCompositeNode(grammarAccess.getTermExpressionAccess().getBinaryComprehensionParserRuleCall_3()); 
    }
    this_BinaryComprehension_3=ruleBinaryComprehension
    { 
        $current = $this_BinaryComprehension_3.current; 
        afterParserOrEnumRuleCall();
    }
)
    |
    { 
        newCompositeNode(grammarAccess.getTermExpressionAccess().getBinaryParserRuleCall_4()); 
    }
    ...
    |(	otherlv_5='#' 
    {
    	newLeafNode(otherlv_5, grammarAccess.getTermExpressionAccess().getNumberSignKeyword_5_0());
    }

    { 
        newCompositeNode(grammarAccess.getTermExpressionAccess().getRecordExprParserRuleCall_5_1()); 
    }
    this_RecordExpr_6=ruleRecordExpr
    { 
        $current = $this_RecordExpr_6.current; 
        afterParserOrEnumRuleCall();
    }
)
    |
    { 
        newCompositeNode(grammarAccess.getTermExpressionAccess().getLiteralExpressionParserRuleCall_6()); 
    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getMacroCallAccess().getArgsExpressionParserRuleCall_1_1_0_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getMacroCallAccess().getCommaKeyword_1_1_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getMacroCallAccess().getArgsExpressionParserRuleCall_1_1_1_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getMacroCallAccess().getRightParenthesisKeyword_1_2());
    }
)?)
;
...
(
		{ 
	        newCompositeNode(grammarAccess.getRecordFieldAccess().getRefAtomMacroParserRuleCall_0_0()); 
	    }
...
(
    { 
        newCompositeNode(grammarAccess.getLiteralExpressionNoNumberAccess().getAtomLiteralParserRuleCall_0()); 
    }
    this_AtomLiteral_0=ruleAtomLiteral
    { 
        $current = $this_AtomLiteral_0.current; 
        afterParserOrEnumRuleCall();
    }
...
(
		lv_value_3_0=RULE_CHAR
		{
			newLeafNode(lv_value_3_0, grammarAccess.getLiteralExpressionNoNumberAccess().getValueCHARTerminalRuleCall_2_1_0()); 
		}
		{
	        if ($current==null) {
    ...
    this_MacroLiteral_4=ruleMacroLiteral
    { 
        $current = $this_MacroLiteral_4.current; 
        afterParserOrEnumRuleCall();
    }
...
// Entry rule entryRuleAtomLiteral
entryRuleAtomLiteral returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getAtomLiteralRule()); }
	 iv_ruleAtomLiteral=ruleAtomLiteral 
	 { $current=$iv_ruleAtomLiteral.current; } 
	 EOF 
;

// Rule AtomLiteral
ruleAtomLiteral returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
    {
        $current = forceCreateModelElement(
            grammarAccess.getAtomLiteralAccess().getAtomAction_0(),
            $current);
    }
)(
(
		{
			if ($current==null) {
	            $current = createModelElement(grammarAccess.getAtomLiteralRule());
	        }
        }
		{ 
	        newCompositeNode(grammarAccess.getAtomLiteralAccess().getValueReferenceableElementCrossReference_1_0()); 
	    }
		ruleNAME		{ 
	        afterParserOrEnumRuleCall();
	    }
...
((
    {
        $current = forceCreateModelElement(
            grammarAccess.getBinaryAccess().getErlBinaryAction_1_0(),
            $current);
    }
)
    |((
...
entryRuleAtomVarMacro returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getAtomVarMacroRule()); }
	 iv_ruleAtomVarMacro=ruleAtomVarMacro 
	 { $current=$iv_ruleAtomVarMacro.current; } 
	 EOF 
;

// Rule AtomVarMacro
ruleAtomVarMacro returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    { 
        newCompositeNode(grammarAccess.getAtomVarMacroAccess().getAtomLiteralParserRuleCall_0()); 
    }
    this_AtomLiteral_0=ruleAtomLiteral
    { 
        $current = $this_AtomLiteral_0.current; 
    ...
    |
    { 
        newCompositeNode(grammarAccess.getAtomVarMacroAccess().getVariableLiteralParserRuleCall_1()); 
    }
    this_VariableLiteral_1=ruleVariableLiteral
    { 
        $current = $this_VariableLiteral_1.current; 
    ...
    |
    { 
        newCompositeNode(grammarAccess.getAtomVarMacroAccess().getMacroLiteralParserRuleCall_2()); 
    }
...
(
    { 
        newCompositeNode(grammarAccess.getAtomVarAccess().getAtomLiteralParserRuleCall_0()); 
    }
    this_AtomLiteral_0=ruleAtomLiteral
    { 
        $current = $this_AtomLiteral_0.current; 
...
(
    { 
        newCompositeNode(grammarAccess.getAtomMacroAccess().getAtomLiteralParserRuleCall_0()); 
    }
    this_AtomLiteral_0=ruleAtomLiteral
    { 
        $current = $this_AtomLiteral_0.current; 
...
(
		{ 
	        newCompositeNode(grammarAccess.getTypeAccess().getMAtomVarMacroParserRuleCall_1_1_0_0()); 
	    }
		lv_m_4_0=ruleAtomVarMacro		{
	        if ($current==null) {
