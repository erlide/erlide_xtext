...
)this_FULL_STOP_5=RULE_FULL_STOP
    { 
    newLeafNode(this_FULL_STOP_5, grammarAccess.getFormAccess().getFULL_STOPTerminalRuleCall_3_2()); 
    }
))
;
...
(
    ...
    { 
        $current = $this_ModuleAttribute_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_DefineAttribute_1.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_UndefAttribute_2.current; 
        afterParserOrEnumRuleCall();
    }

    |
    { 
        newCompositeNode(grammarAccess.getAttributeAccess().getIncludeAttributeParserRuleCall_3()); 
    }
    this_IncludeAttribute_3=ruleIncludeAttribute
    { 
        $current = $this_IncludeAttribute_3.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    |
    { 
        newCompositeNode(grammarAccess.getAttributeAccess().getCustomAttributeParserRuleCall_7()); 
    }
    this_CustomAttribute_7=ruleCustomAttribute
    { 
        $current = $this_CustomAttribute_7.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
(	otherlv_0='-' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getDefineAttributeAccess().getHyphenMinusKeyword_0());
    }
((
(
	'define' 
...
(
		lv_tag_1_0=	'define' 
    {
        newLeafNode(lv_tag_1_0, grammarAccess.getDefineAttributeAccess().getTagDefineKeyword_1_0());
    }
 
	    {
	        if ($current==null) {
       		...
       		setWithLastConsumed($current, "tag", lv_tag_1_0, "define");
	    }
...
(
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getDefineAttributeAccess().getLeftParenthesisKeyword_4_0());
    }
((
(
		{ 
	        newCompositeNode(grammarAccess.getDefineAttributeAccess().getArgsPatternExpressionParserRuleCall_4_1_0_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_6, grammarAccess.getDefineAttributeAccess().getCommaKeyword_4_1_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getDefineAttributeAccess().getArgsPatternExpressionParserRuleCall_4_1_1_1_0()); 
	    }
		lv_args_7_0=rulePatternExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getDefineAttributeRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_8, grammarAccess.getDefineAttributeAccess().getRightParenthesisKeyword_4_2());
    }
)?(	otherlv_9=',' 
    {
    	newLeafNode(otherlv_9, grammarAccess.getDefineAttributeAccess().getCommaKeyword_5_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getDefineAttributeAccess().getValueGuardParserRuleCall_5_1_0()); 
	    }
		lv_value_10_0=ruleGuard		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getDefineAttributeRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_11, grammarAccess.getDefineAttributeAccess().getRightParenthesisKeyword_6());
    }
this_FULL_STOP_12=RULE_FULL_STOP
    { 
    newLeafNode(this_FULL_STOP_12, grammarAccess.getDefineAttributeAccess().getFULL_STOPTerminalRuleCall_7()); 
    }
)
;
...
(	otherlv_0='-' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getUndefAttributeAccess().getHyphenMinusKeyword_0());
    }
((
(
	'undef' 
...
(
		lv_tag_1_0=	'undef' 
    {
        newLeafNode(lv_tag_1_0, grammarAccess.getUndefAttributeAccess().getTagUndefKeyword_1_0());
    }
 
	    {
	        if ($current==null) {
       		...
       		setWithLastConsumed($current, "tag", lv_tag_1_0, "undef");
	    }
...
(
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getUndefAttributeAccess().getRightParenthesisKeyword_4());
    }
this_FULL_STOP_5=RULE_FULL_STOP
    { 
    newLeafNode(this_FULL_STOP_5, grammarAccess.getUndefAttributeAccess().getFULL_STOPTerminalRuleCall_5()); 
    }
)
;
...
this_FULL_STOP_5=RULE_FULL_STOP
    { 
    newLeafNode(this_FULL_STOP_5, grammarAccess.getIfdefAttributeAccess().getFULL_STOPTerminalRuleCall_5()); 
    }
)
;
...
(	otherlv_0='-' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getIncludeAttributeAccess().getHyphenMinusKeyword_0());
    }
((
(
(
...
(
		lv_tag_1_1=	'include' 
    {
        newLeafNode(lv_tag_1_1, grammarAccess.getIncludeAttributeAccess().getTagIncludeKeyword_1_0_0());
    }
    ...
    |		lv_tag_1_2=	'include_lib' 
    {
        newLeafNode(lv_tag_1_2, grammarAccess.getIncludeAttributeAccess().getTagInclude_libKeyword_1_0_1());
    }
...
(
	...
	{
		newLeafNode(otherlv_3, grammarAccess.getIncludeAttributeAccess().getValueModuleCrossReference_3_0()); 
	}

)
)	otherlv_4=')' 
    {
    	newLeafNode(otherlv_4, grammarAccess.getIncludeAttributeAccess().getRightParenthesisKeyword_4());
    }
this_FULL_STOP_5=RULE_FULL_STOP
    { 
    newLeafNode(this_FULL_STOP_5, grammarAccess.getIncludeAttributeAccess().getFULL_STOPTerminalRuleCall_5()); 
    }
)
;
...
(	otherlv_0='-' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getFileAttributeAccess().getHyphenMinusKeyword_0());
    }
((
(
	'file' 
...
(
		lv_tag_1_0=	'file' 
    {
        newLeafNode(lv_tag_1_0, grammarAccess.getFileAttributeAccess().getTagFileKeyword_1_0());
    }
 
	    {
	        if ($current==null) {
       		...
       		setWithLastConsumed($current, "tag", lv_tag_1_0, "file");
	    }

)
)	otherlv_2='(' 
    {
    	newLeafNode(otherlv_2, grammarAccess.getFileAttributeAccess().getLeftParenthesisKeyword_2());
    }
(
(
		lv_file_3_0=RULE_STRING
		{
			newLeafNode(lv_file_3_0, grammarAccess.getFileAttributeAccess().getFileSTRINGTerminalRuleCall_3_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getFileAttributeRule());
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getFileAttributeAccess().getCommaKeyword_4());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getFileAttributeAccess().getLineINTEGERParserRuleCall_5_0()); 
	    }
		lv_line_5_0=ruleINTEGER		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_6, grammarAccess.getFileAttributeAccess().getRightParenthesisKeyword_6());
    }
this_FULL_STOP_7=RULE_FULL_STOP
    { 
    newLeafNode(this_FULL_STOP_7, grammarAccess.getFileAttributeAccess().getFULL_STOPTerminalRuleCall_7()); 
    }
)
;
...
(	otherlv_0='-' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getModuleAttributeAccess().getHyphenMinusKeyword_0());
    }
((
(
	'module' 
...
(
		lv_tag_1_0=	'module' 
    {
        newLeafNode(lv_tag_1_0, grammarAccess.getModuleAttributeAccess().getTagModuleKeyword_1_0());
    }
 
	    {
	        if ($current==null) {
       		...
       		setWithLastConsumed($current, "tag", lv_tag_1_0, "module");
	    }

)
)	otherlv_2='(' 
    {
    	newLeafNode(otherlv_2, grammarAccess.getModuleAttributeAccess().getLeftParenthesisKeyword_2());
    }
(
(
		{ 
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getModuleAttributeAccess().getRightParenthesisKeyword_4());
    }
this_FULL_STOP_5=RULE_FULL_STOP
    { 
    newLeafNode(this_FULL_STOP_5, grammarAccess.getModuleAttributeAccess().getFULL_STOPTerminalRuleCall_5()); 
    }
)
;
...
(	otherlv_0='-' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getRecordAttributeAccess().getHyphenMinusKeyword_0());
    }
((
(
	'record' 
...
(
		lv_tag_1_0=	'record' 
    {
        newLeafNode(lv_tag_1_0, grammarAccess.getRecordAttributeAccess().getTagRecordKeyword_1_0());
    }
 
	    {
	        if ($current==null) {
       		...
       		setWithLastConsumed($current, "tag", lv_tag_1_0, "record");
	    }

)
)	otherlv_2='(' 
    {
    	newLeafNode(otherlv_2, grammarAccess.getRecordAttributeAccess().getLeftParenthesisKeyword_2());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getRecordAttributeAccess().getNameNameVarParserRuleCall_3_0()); 
	    }
		lv_name_3_0=ruleNameVar		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getRecordAttributeAccess().getCommaKeyword_4());
    }
((	otherlv_5='{' 
    {
    	newLeafNode(otherlv_5, grammarAccess.getRecordAttributeAccess().getLeftCurlyBracketKeyword_5_0_0());
    }
((
(
		{ 
	        newCompositeNode(grammarAccess.getRecordAttributeAccess().getFieldsRecordFieldDefParserRuleCall_5_0_1_0_0()); 
	    }
		lv_fields_6_0=ruleRecordFieldDef		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getRecordAttributeRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_7, grammarAccess.getRecordAttributeAccess().getCommaKeyword_5_0_1_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getRecordAttributeAccess().getFieldsRecordFieldDefParserRuleCall_5_0_1_1_1_0()); 
	    }
		lv_fields_8_0=ruleRecordFieldDef		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getRecordAttributeRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_9, grammarAccess.getRecordAttributeAccess().getRightCurlyBracketKeyword_5_0_2());
    }
)
    |(
(
		...
		{ 
	        newCompositeNode(grammarAccess.getRecordAttributeAccess().getRecordMacroDefineAttributeCrossReference_5_1_0()); 
	    }
		ruleMacro		{ 
	        afterParserOrEnumRuleCall();
	    }
    ...
    {
    	newLeafNode(otherlv_11, grammarAccess.getRecordAttributeAccess().getRightParenthesisKeyword_6());
    }
this_FULL_STOP_12=RULE_FULL_STOP
    { 
    newLeafNode(this_FULL_STOP_12, grammarAccess.getRecordAttributeAccess().getFULL_STOPTerminalRuleCall_7()); 
    }
)
;
...
(	otherlv_0='-' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getSpecAttributeAccess().getHyphenMinusKeyword_0());
    }
((
(
(
...
(
		lv_tag_1_1=	'spec' 
    {
        newLeafNode(lv_tag_1_1, grammarAccess.getSpecAttributeAccess().getTagSpecKeyword_1_0_0());
    }
    ...
    |		lv_tag_1_2=	'callback' 
    {
        newLeafNode(lv_tag_1_2, grammarAccess.getSpecAttributeAccess().getTagCallbackKeyword_1_0_1());
    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getSpecAttributeAccess().getTypeSpecFunParserRuleCall_2_0_0_0()); 
	    }
		lv_type_2_0=ruleSpecFun		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getSpecAttributeAccess().getSignaturesTypeSigsParserRuleCall_2_0_1_0()); 
	    }
		lv_signatures_3_0=ruleTypeSigs		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getSpecAttributeRule());
	        }
       		set(
    ...
    |(	otherlv_4='(' 
    {
    	newLeafNode(otherlv_4, grammarAccess.getSpecAttributeAccess().getLeftParenthesisKeyword_2_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getSpecAttributeAccess().getTypeSpecFunParserRuleCall_2_1_1_0()); 
	    }
		lv_type_5_0=ruleSpecFun		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getSpecAttributeRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getSpecAttributeAccess().getSignaturesTypeSigsParserRuleCall_2_1_2_0()); 
	    }
		lv_signatures_6_0=ruleTypeSigs		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getSpecAttributeRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_7, grammarAccess.getSpecAttributeAccess().getRightParenthesisKeyword_2_1_3());
    }
))this_FULL_STOP_8=RULE_FULL_STOP
    { 
    newLeafNode(this_FULL_STOP_8, grammarAccess.getSpecAttributeAccess().getFULL_STOPTerminalRuleCall_3()); 
    }
)
;
...
(	otherlv_0='-' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getTypeAttributeAccess().getHyphenMinusKeyword_0());
    }
((
(
(
...
(
		lv_tag_1_1=	'type' 
    {
        newLeafNode(lv_tag_1_1, grammarAccess.getTypeAttributeAccess().getTagTypeKeyword_1_0_0());
    }
    ...
    |		lv_tag_1_2=	'opaque' 
    {
        newLeafNode(lv_tag_1_2, grammarAccess.getTypeAttributeAccess().getTagOpaqueKeyword_1_0_1());
    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getTypeAttributeAccess().getNameNameVarParserRuleCall_2_0_0_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getTypeAttributeAccess().getLeftParenthesisKeyword_2_0_1());
    }
((
(
		{ 
	        newCompositeNode(grammarAccess.getTypeAttributeAccess().getArgsPatternExpressionParserRuleCall_2_0_2_0_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getTypeAttributeAccess().getCommaKeyword_2_0_2_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTypeAttributeAccess().getArgsPatternExpressionParserRuleCall_2_0_2_1_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_7, grammarAccess.getTypeAttributeAccess().getRightParenthesisKeyword_2_0_3());
    }
	otherlv_8='::' 
    {
    	newLeafNode(otherlv_8, grammarAccess.getTypeAttributeAccess().getColonColonKeyword_2_0_4());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTypeAttributeAccess().getTypeTopTypeParserRuleCall_2_0_5_0()); 
	    }
		lv_type_9_0=ruleTopType		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTypeAttributeRule());
	        }
       		set(
    ...
    |(	otherlv_10='(' 
    {
    	newLeafNode(otherlv_10, grammarAccess.getTypeAttributeAccess().getLeftParenthesisKeyword_2_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTypeAttributeAccess().getNameNameVarParserRuleCall_2_1_1_0()); 
	    }
		lv_name_11_0=ruleNameVar		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTypeAttributeRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_12, grammarAccess.getTypeAttributeAccess().getLeftParenthesisKeyword_2_1_2());
    }
((
(
		{ 
	        newCompositeNode(grammarAccess.getTypeAttributeAccess().getArgsPatternExpressionParserRuleCall_2_1_3_0_0()); 
	    }
		lv_args_13_0=rulePatternExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTypeAttributeRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_14, grammarAccess.getTypeAttributeAccess().getCommaKeyword_2_1_3_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTypeAttributeAccess().getArgsPatternExpressionParserRuleCall_2_1_3_1_1_0()); 
	    }
		lv_args_15_0=rulePatternExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTypeAttributeRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_16, grammarAccess.getTypeAttributeAccess().getRightParenthesisKeyword_2_1_4());
    }
	otherlv_17='::' 
    {
    	newLeafNode(otherlv_17, grammarAccess.getTypeAttributeAccess().getColonColonKeyword_2_1_5());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTypeAttributeAccess().getTypeTopTypeParserRuleCall_2_1_6_0()); 
	    }
		lv_type_18_0=ruleTopType		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTypeAttributeRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_19, grammarAccess.getTypeAttributeAccess().getRightParenthesisKeyword_2_1_7());
    }
))this_FULL_STOP_20=RULE_FULL_STOP
    { 
    newLeafNode(this_FULL_STOP_20, grammarAccess.getTypeAttributeAccess().getFULL_STOPTerminalRuleCall_3()); 
    }
)
;
...
(	otherlv_0='-' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getCustomAttributeAccess().getHyphenMinusKeyword_0());
    }
(
(
		lv_tag_1_0=RULE_ATOM
		{
			newLeafNode(lv_tag_1_0, grammarAccess.getCustomAttributeAccess().getTagATOMTerminalRuleCall_1_0()); 
		}
		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getCustomAttributeAccess().getLeftParenthesisKeyword_2());
    }
((
(
		{ 
	        newCompositeNode(grammarAccess.getCustomAttributeAccess().getValueExpressionParserRuleCall_3_0_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getCustomAttributeAccess().getCommaKeyword_3_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getCustomAttributeAccess().getValueExpressionParserRuleCall_3_1_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_6, grammarAccess.getCustomAttributeAccess().getRightParenthesisKeyword_4());
    }
this_FULL_STOP_7=RULE_FULL_STOP
    { 
    newLeafNode(this_FULL_STOP_7, grammarAccess.getCustomAttributeAccess().getFULL_STOPTerminalRuleCall_5()); 
    }
)
;
...
(
    ...
    { 
    newLeafNode(this_FULL_STOP_4, grammarAccess.getFunctionAccess().getFULL_STOPTerminalRuleCall_3()); 
    }
)
;
...
(
		{ 
	        newCompositeNode(grammarAccess.getFunctionClauseAccess().getParamsExpressionParserRuleCall_2_0_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getFunctionClauseAccess().getCommaKeyword_2_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getFunctionClauseAccess().getParamsExpressionParserRuleCall_2_1_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getFunctionClauseAccess().getRightParenthesisKeyword_3());
    }
((	otherlv_6='when' 
    {
    	newLeafNode(otherlv_6, grammarAccess.getFunctionClauseAccess().getWhenKeyword_4_0());
    }
)?(
(
		{ 
    ...
    {
    	newLeafNode(otherlv_8, grammarAccess.getFunctionClauseAccess().getHyphenMinusGreaterThanSignKeyword_5());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getFunctionClauseAccess().getBodyLExpressionParserRuleCall_6_0()); 
	    }
		lv_body_9_0=ruleLExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getFunctionClauseRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_10, grammarAccess.getFunctionClauseAccess().getCommaKeyword_7_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getFunctionClauseAccess().getBodyLExpressionParserRuleCall_7_1_0()); 
	    }
		lv_body_11_0=ruleLExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getFunctionClauseRule());
	        }
       		add(
...
(
		lv_op_5_0=	'!' 
    {
        newLeafNode(lv_op_5_0, grammarAccess.getExpr100Access().getOpExclamationMarkKeyword_1_1_1_0());
    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getExpr700Access().getArgsExpressionParserRuleCall_1_0_2_0_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getExpr700Access().getCommaKeyword_1_0_2_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getExpr700Access().getArgsExpressionParserRuleCall_1_0_2_1_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_6, grammarAccess.getExpr700Access().getRightParenthesisKeyword_1_0_3());
    }
)
    |(	otherlv_7='#' 
    {
    	newLeafNode(otherlv_7, grammarAccess.getExpr700Access().getNumberSignKeyword_1_1_0());
    }
(
    {
        $current = forceCreateModelElementAndSet(
...
(
		{ 
	        newCompositeNode(grammarAccess.getExprMaxAccess().getBodyLExpressionParserRuleCall_2_2_0()); 
	    }
		lv_body_6_0=ruleLExpression		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_7, grammarAccess.getExprMaxAccess().getCommaKeyword_2_3_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getExprMaxAccess().getBodyLExpressionParserRuleCall_2_3_1_0()); 
	    }
		lv_body_8_0=ruleLExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getExprMaxRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_9, grammarAccess.getExprMaxAccess().getEndKeyword_2_4());
    }
)
    |
    { 
    ...
    this_IfExpr_10=ruleIfExpr
    { 
        $current = $this_IfExpr_10.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    this_CaseExpr_11=ruleCaseExpr
    { 
        $current = $this_CaseExpr_11.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    this_ReceiveExpr_12=ruleReceiveExpr
    { 
        $current = $this_ReceiveExpr_12.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    this_FunExpr_13=ruleFunExpr
    { 
        $current = $this_FunExpr_13.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    this_TryExpr_14=ruleTryExpr
    { 
        $current = $this_TryExpr_14.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    this_CondExpr_15=ruleCondExpr
    { 
        $current = $this_CondExpr_15.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    this_QueryExpr_16=ruleQueryExpr
    { 
        $current = $this_QueryExpr_16.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    this_LetExpr_17=ruleLetExpr
    { 
        $current = $this_LetExpr_17.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
(
    ...
    |((	ruleMacroCall)=>
    { 
        newCompositeNode(grammarAccess.getTermExpressionAccess().getMacroCallParserRuleCall_1()); 
    }
    ...
    { 
        newCompositeNode(grammarAccess.getTermExpressionAccess().getListComprehensionParserRuleCall_2()); 
    }
    this_ListComprehension_2=ruleListComprehension
    { 
        $current = $this_ListComprehension_2.current; 
        afterParserOrEnumRuleCall();
    }
)
    |
    { 
        newCompositeNode(grammarAccess.getTermExpressionAccess().getListParserRuleCall_3()); 
    }
    ...
    { 
        newCompositeNode(grammarAccess.getTermExpressionAccess().getBinaryComprehensionParserRuleCall_4()); 
    }
    this_BinaryComprehension_4=ruleBinaryComprehension
    { 
        $current = $this_BinaryComprehension_4.current; 
        afterParserOrEnumRuleCall();
    }
)
    |
    { 
        newCompositeNode(grammarAccess.getTermExpressionAccess().getBinaryParserRuleCall_5()); 
    }
    this_Binary_5=ruleBinary
    { 
        $current = $this_Binary_5.current; 
        afterParserOrEnumRuleCall();
    }

    |(	otherlv_6='#' 
    {
    	newLeafNode(otherlv_6, grammarAccess.getTermExpressionAccess().getNumberSignKeyword_6_0());
    }

    { 
        newCompositeNode(grammarAccess.getTermExpressionAccess().getRecordExprParserRuleCall_6_1()); 
    }
    this_RecordExpr_7=ruleRecordExpr
    { 
        $current = $this_RecordExpr_7.current; 
        afterParserOrEnumRuleCall();
    }
)
    |
    { 
        newCompositeNode(grammarAccess.getTermExpressionAccess().getLiteralExpressionParserRuleCall_7()); 
    }
...
(
    ...
    {
    	newLeafNode(otherlv_1, grammarAccess.getMacroCallAccess().getLeftParenthesisKeyword_1());
    }
((
(
		{ 
	        newCompositeNode(grammarAccess.getMacroCallAccess().getArgsExpressionParserRuleCall_2_0_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getMacroCallAccess().getCommaKeyword_2_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getMacroCallAccess().getArgsExpressionParserRuleCall_2_1_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getMacroCallAccess().getRightParenthesisKeyword_3());
    }
)
;
...
(
		...
		{ 
	        newCompositeNode(grammarAccess.getRecordExprAccess().getFieldRecordFieldDefCrossReference_1_0_0()); 
	    }
		ruleQName		{ 
	        afterParserOrEnumRuleCall();
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getRecordTupleAccess().getFieldsRecordFieldParserRuleCall_2_0_0()); 
	    }
		lv_fields_2_0=ruleRecordField		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getRecordTupleAccess().getFieldsRecordFieldParserRuleCall_2_1_1_0()); 
	    }
...
(
    ...
    {
    	newLeafNode(otherlv_1, grammarAccess.getRecordFieldAccess().getEqualsSignKeyword_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getRecordFieldAccess().getValueExpressionParserRuleCall_1_1_0()); 
	    }
		lv_value_2_0=ruleExpression		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getRecordFieldAccess().getColonColonKeyword_2_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getRecordFieldAccess().getTypeTopTypeParserRuleCall_2_1_0()); 
	    }
		lv_type_4_0=ruleTopType		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getRecordFieldRule());
...
(
    ...
    {
        $current = forceCreateModelElement(
            grammarAccess.getLiteralExpressionNoNumberAccess().getVariableAction_1_0(),
            $current);
    }
)(
(
		lv_value_3_0=RULE_VARIABLE
		{
			newLeafNode(lv_value_3_0, grammarAccess.getLiteralExpressionNoNumberAccess().getValueVARIABLETerminalRuleCall_1_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getLiteralExpressionNoNumberRule());
    ...
    {
        $current = forceCreateModelElement(
            grammarAccess.getLiteralExpressionNoNumberAccess().getCharAction_2_0(),
            $current);
    }
)(
(
		lv_value_5_0=RULE_CHAR
		{
			newLeafNode(lv_value_5_0, grammarAccess.getLiteralExpressionNoNumberAccess().getValueCHARTerminalRuleCall_2_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getLiteralExpressionNoNumberRule());
    ...
    {
        $current = forceCreateModelElement(
            grammarAccess.getLiteralExpressionNoNumberAccess().getMacroExprAction_3_0(),
            $current);
    }
)(
(
		...
		{ 
	        newCompositeNode(grammarAccess.getLiteralExpressionNoNumberAccess().getValueDefineAttributeCrossReference_3_1_0()); 
	    }
		ruleMacro		{ 
	        afterParserOrEnumRuleCall();
	    }
...
(
    ...
    {
        $current = forceCreateModelElement(
            grammarAccess.getLiteralExpressionAccess().getIntegerAction_1_0(),
            $current);
    }
)(
(
		{ 
	        newCompositeNode(grammarAccess.getLiteralExpressionAccess().getValueINTEGERParserRuleCall_1_1_0()); 
	    }
    ...
    {
        $current = forceCreateModelElement(
            grammarAccess.getLiteralExpressionAccess().getFloatAction_2_0(),
            $current);
    }
)(
(
...
(
		{ 
	        newCompositeNode(grammarAccess.getPatternExpressionAccess().getArgsExpressionParserRuleCall_1_1_2_0_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_7, grammarAccess.getPatternExpressionAccess().getCommaKeyword_1_1_2_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getPatternExpressionAccess().getArgsExpressionParserRuleCall_1_1_2_1_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_9, grammarAccess.getPatternExpressionAccess().getRightParenthesisKeyword_1_1_3());
    }
))?)
;
...
(
		{ 
	        newCompositeNode(grammarAccess.getIfClauseAccess().getBodyLExpressionParserRuleCall_2_0()); 
	    }
		lv_body_2_0=ruleLExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getIfClauseRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getIfClauseAccess().getCommaKeyword_3_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getIfClauseAccess().getBodyLExpressionParserRuleCall_3_1_0()); 
	    }
		lv_body_4_0=ruleLExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getIfClauseRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getCrClauseAccess().getBodyLExpressionParserRuleCall_3_0()); 
	    }
		lv_body_4_0=ruleLExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getCrClauseRule());
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getCrClauseAccess().getCommaKeyword_4_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getCrClauseAccess().getBodyLExpressionParserRuleCall_4_1_0()); 
	    }
		lv_body_6_0=ruleLExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getCrClauseRule());
...
(
		{ 
	        newCompositeNode(grammarAccess.getReceiveExprAccess().getAfter_bodyLExpressionParserRuleCall_1_0_2_3_0()); 
	    }
		lv_after_body_7_0=ruleLExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getReceiveExprRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_8, grammarAccess.getReceiveExprAccess().getCommaKeyword_1_0_2_4_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getReceiveExprAccess().getAfter_bodyLExpressionParserRuleCall_1_0_2_4_1_0()); 
	    }
		lv_after_body_9_0=ruleLExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getReceiveExprRule());
	        }
       		add(
    ...
    |(	otherlv_10='after' 
    {
    	newLeafNode(otherlv_10, grammarAccess.getReceiveExprAccess().getAfterKeyword_1_1_0());
    }
(
(
		{ 
		...
		lv_after_expr_11_0=ruleExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getReceiveExprRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_12, grammarAccess.getReceiveExprAccess().getHyphenMinusGreaterThanSignKeyword_1_1_2());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getReceiveExprAccess().getAfter_bodyLExpressionParserRuleCall_1_1_3_0()); 
	    }
		lv_after_body_13_0=ruleLExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getReceiveExprRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_14, grammarAccess.getReceiveExprAccess().getCommaKeyword_1_1_4_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getReceiveExprAccess().getAfter_bodyLExpressionParserRuleCall_1_1_4_1_0()); 
	    }
		lv_after_body_15_0=ruleLExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getReceiveExprRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_16, grammarAccess.getReceiveExprAccess().getEndKeyword_2());
    }
)
;
...
(
    { 
        newCompositeNode(grammarAccess.getFunExprAccess().getRefFunParserRuleCall_1_0()); 
    }
    this_RefFun_1=ruleRefFun
    { 
        $current = $this_RefFun_1.current; 
        afterParserOrEnumRuleCall();
    }
...
// Entry rule entryRuleRefFun
entryRuleRefFun returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getRefFunRule()); }
	 iv_ruleRefFun=ruleRefFun 
	 { $current=$iv_ruleRefFun.current; } 
	 EOF 
;

// Rule RefFun
ruleRefFun returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(((
(
		{ 
	        newCompositeNode(grammarAccess.getRefFunAccess().getModuleLiteralExpressionNoNumberParserRuleCall_0_0_0()); 
	    }
		lv_module_0_0=ruleLiteralExpressionNoNumber		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getRefFunRule());
	        }
       		set(
       			$current, 
       			"module",
    ...
    {
    	newLeafNode(otherlv_1, grammarAccess.getRefFunAccess().getColonKeyword_0_1());
    }
)?(
(
		{ 
	        newCompositeNode(grammarAccess.getRefFunAccess().getFunctionLiteralExpressionNoNumberParserRuleCall_1_0()); 
	    }
		lv_function_2_0=ruleLiteralExpressionNoNumber		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getRefFunRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getRefFunAccess().getSolidusKeyword_2());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getRefFunAccess().getArityIntMacroParserRuleCall_3_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getTryExprAccess().getBodyLExpressionParserRuleCall_1_0()); 
	    }
		lv_body_1_0=ruleLExpression		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getTryExprAccess().getCommaKeyword_2_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTryExprAccess().getBodyLExpressionParserRuleCall_2_1_0()); 
	    }
		lv_body_3_0=ruleLExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTryExprRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getTryExprAccess().getOfKeyword_3_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTryExprAccess().getOf_clausesCrClauseParserRuleCall_3_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_6, grammarAccess.getTryExprAccess().getSemicolonKeyword_3_2_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTryExprAccess().getOf_clausesCrClauseParserRuleCall_3_2_1_0()); 
	    }
		lv_of_clauses_7_0=ruleCrClause		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTryExprRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_8, grammarAccess.getTryExprAccess().getCatchKeyword_4_0_0());
    }
((((
(
ruleNameVar
...
(
		{ 
	        newCompositeNode(grammarAccess.getTryExprAccess().getCatchTryClauseParserRuleCall_4_0_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_10, grammarAccess.getTryExprAccess().getSemicolonKeyword_4_0_2_0());
    }
((((
(
ruleNameVar
...
(
		{ 
	        newCompositeNode(grammarAccess.getTryExprAccess().getCatchTryClauseParserRuleCall_4_0_2_1_0()); 
	    }
		lv_catch_11_0=ruleTryClause		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTryExprRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_12, grammarAccess.getTryExprAccess().getAfterKeyword_4_0_3_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTryExprAccess().getAfter_bodyLExpressionParserRuleCall_4_0_3_1_0()); 
	    }
		lv_after_body_13_0=ruleLExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTryExprRule());
    ...
    {
    	newLeafNode(otherlv_14, grammarAccess.getTryExprAccess().getCommaKeyword_4_0_3_2_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTryExprAccess().getAfter_bodyLExpressionParserRuleCall_4_0_3_2_1_0()); 
	    }
		lv_after_body_15_0=ruleLExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTryExprRule());
    ...
    |(	otherlv_16='after' 
    {
    	newLeafNode(otherlv_16, grammarAccess.getTryExprAccess().getAfterKeyword_4_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTryExprAccess().getAfter_bodyLExpressionParserRuleCall_4_1_1_0()); 
	    }
		lv_after_body_17_0=ruleLExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTryExprRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_18, grammarAccess.getTryExprAccess().getCommaKeyword_4_1_2_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTryExprAccess().getAfter_bodyLExpressionParserRuleCall_4_1_2_1_0()); 
	    }
		lv_after_body_19_0=ruleLExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTryExprRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_20, grammarAccess.getTryExprAccess().getEndKeyword_5());
    }
)
;
...
(
		{ 
	        newCompositeNode(grammarAccess.getTryClauseAccess().getBodyLExpressionParserRuleCall_4_0()); 
	    }
		lv_body_6_0=ruleLExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTryClauseRule());
    ...
    {
    	newLeafNode(otherlv_7, grammarAccess.getTryClauseAccess().getCommaKeyword_5_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTryClauseAccess().getBodyLExpressionParserRuleCall_5_1_0()); 
	    }
		lv_body_8_0=ruleLExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTryClauseRule());
...
((
    {
        $current = forceCreateModelElement(
            grammarAccess.getListAccess().getListAction_1_0(),
            $current);
    }
)
    |((
(
		{ 
	        newCompositeNode(grammarAccess.getListAccess().getElementsExpressionParserRuleCall_1_1_0_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getListAccess().getCommaKeyword_1_1_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getListAccess().getElementsExpressionParserRuleCall_1_1_1_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getListAccess().getVerticalLineKeyword_1_1_2_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getListAccess().getTailExpressionParserRuleCall_1_1_2_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_7, grammarAccess.getListAccess().getRightSquareBracketKeyword_2());
    }
)
;
...
(
		{ 
	        newCompositeNode(grammarAccess.getListComprehensionAccess().getElementExpressionParserRuleCall_1_0()); 
	    }
		lv_element_1_0=ruleExpression		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getListComprehensionAccess().getVerticalLineVerticalLineKeyword_2());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getListComprehensionAccess().getGeneratorsLCExprParserRuleCall_3_0()); 
	    }
		lv_generators_3_0=ruleLCExpr		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getListComprehensionRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getListComprehensionAccess().getCommaKeyword_4_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getListComprehensionAccess().getGeneratorsLCExprParserRuleCall_4_1_0()); 
	    }
		lv_generators_5_0=ruleLCExpr		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getListComprehensionRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_6, grammarAccess.getListComprehensionAccess().getRightSquareBracketKeyword_5());
    }
)
;
...
((
    {
        $current = forceCreateModelElement(
            grammarAccess.getTupleAccess().getTupleAction_1_0(),
            $current);
    }
)
    |((
...
entryRuleBinaryComprehension returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getBinaryComprehensionRule()); }
	 iv_ruleBinaryComprehension=ruleBinaryComprehension 
	 { $current=$iv_ruleBinaryComprehension.current; } 
	 EOF 
;

// Rule BinaryComprehension
ruleBinaryComprehension returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='<<' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getBinaryComprehensionAccess().getLessThanSignLessThanSignKeyword_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getBinaryComprehensionAccess().getExprTermExpressionParserRuleCall_1_0()); 
	    }
		lv_expr_1_0=ruleTermExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getBinaryComprehensionRule());
	        }
       		set(
       			$current, 
       			"expr",
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getBinaryComprehensionAccess().getVerticalLineVerticalLineKeyword_2());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getBinaryComprehensionAccess().getGeneratorsLCExprParserRuleCall_3_0()); 
	    }
		lv_generators_3_0=ruleLCExpr		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getBinaryComprehensionRule());
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getBinaryComprehensionAccess().getCommaKeyword_4_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getBinaryComprehensionAccess().getGeneratorsLCExprParserRuleCall_4_1_0()); 
	    }
		lv_generators_5_0=ruleLCExpr		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getBinaryComprehensionRule());
    ...
    {
    	newLeafNode(otherlv_6, grammarAccess.getBinaryComprehensionAccess().getGreaterThanSignGreaterThanSignKeyword_5());
    }
)
;
...
(	otherlv_0='<<' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getBinaryAccess().getLessThanSignLessThanSignKeyword_0());
    }
((
    {
        $current = forceCreateModelElement(
            grammarAccess.getBinaryAccess().getBinaryAction_1_0(),
            $current);
    }
)
    |((
(
		{ 
	        newCompositeNode(grammarAccess.getBinaryAccess().getElementsBinaryItemParserRuleCall_1_1_0_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getBinaryAccess().getCommaKeyword_1_1_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getBinaryAccess().getElementsBinaryItemParserRuleCall_1_1_1_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getBinaryAccess().getGreaterThanSignGreaterThanSignKeyword_2());
    }
)
;
...
(
    ...
    |
    { 
        newCompositeNode(grammarAccess.getNameAccess().getMacroParserRuleCall_1()); 
    }
    this_Macro_1=ruleMacro    {
		$current.merge(this_Macro_1);
    }
...
(
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getQNameAccess().getFullStopKeyword_0()); 
    }

    { 
        newCompositeNode(grammarAccess.getQNameAccess().getNameParserRuleCall_1()); 
    }
...
(
    ...
    |
    { 
        newCompositeNode(grammarAccess.getNameVarAccess().getMacroParserRuleCall_1()); 
    }
    this_Macro_1=ruleMacro    {
		$current.merge(this_Macro_1);
    }
...
entryRuleIntMacro returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getIntMacroRule()); } 
	 iv_ruleIntMacro=ruleIntMacro 
	 { $current=$iv_ruleIntMacro.current.getText(); }  
	 EOF 
;

// Rule IntMacro
ruleIntMacro returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(    this_INT_0=RULE_INT    {
    ...
    { 
    newLeafNode(this_INT_0, grammarAccess.getIntMacroAccess().getINTTerminalRuleCall_0()); 
    }

    |
    { 
        newCompositeNode(grammarAccess.getIntMacroAccess().getMacroParserRuleCall_1()); 
    }
    this_Macro_1=ruleMacro    {
		$current.merge(this_Macro_1);
    }
    ...
    { 
    newLeafNode(this_VARIABLE_2, grammarAccess.getIntMacroAccess().getVARIABLETerminalRuleCall_2()); 
    }
)
    ;
...
(
		{ 
	        newCompositeNode(grammarAccess.getSpecFunAccess().getMNameVarParserRuleCall_0_0_0()); 
	    }
		lv_m_0_0=ruleNameVar		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getSpecFunAccess().getFNameVarParserRuleCall_1_0()); 
	    }
		lv_f_2_0=ruleNameVar		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getSpecFunRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getSpecFunAccess().getAIntMacroParserRuleCall_2_1_0()); 
	    }
		lv_a_4_0=ruleIntMacro		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getSpecFunRule());
	        }
       		set(
...
// Entry rule entryRuleTypeSigs
entryRuleTypeSigs returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getTypeSigsRule()); }
	 iv_ruleTypeSigs=ruleTypeSigs 
	 { $current=$iv_ruleTypeSigs.current; } 
	 EOF 
;

// Rule TypeSigs
ruleTypeSigs returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
(
		{ 
	        newCompositeNode(grammarAccess.getTypeSigsAccess().getItemsTypeSigParserRuleCall_0_0()); 
	    }
		lv_items_0_0=ruleTypeSig		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTypeSigsRule());
	        }
       		add(
       			$current, 
       			"items",
    ...
    {
    	newLeafNode(otherlv_1, grammarAccess.getTypeSigsAccess().getSemicolonKeyword_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTypeSigsAccess().getItemsTypeSigParserRuleCall_1_1_0()); 
	    }
		lv_items_2_0=ruleTypeSig		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTypeSigsRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getFunTypeAccess().getArgsTopTypesParserRuleCall_1_0()); 
	    }
		lv_args_1_0=ruleTopTypes		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getFunTypeAccess().getRightParenthesisKeyword_2());
    }
	otherlv_3='->' 
    {
    	newLeafNode(otherlv_3, grammarAccess.getFunTypeAccess().getHyphenMinusGreaterThanSignKeyword_3());
    }
(
(
		{ 
...
// Entry rule entryRuleTopTypes
entryRuleTopTypes returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getTopTypesRule()); }
	 iv_ruleTopTypes=ruleTopTypes 
	 { $current=$iv_ruleTopTypes.current; } 
	 EOF 
;

// Rule TopTypes
ruleTopTypes returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
(
		{ 
	        newCompositeNode(grammarAccess.getTopTypesAccess().getItemsTopTypeParserRuleCall_0_0()); 
	    }
		lv_items_0_0=ruleTopType		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTopTypesRule());
	        }
       		add(
       			$current, 
       			"items",
    ...
    {
    	newLeafNode(otherlv_1, grammarAccess.getTopTypesAccess().getCommaKeyword_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTopTypesAccess().getItemsTopTypeParserRuleCall_1_1_0()); 
	    }
		lv_items_2_0=ruleTopType		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTopTypesRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getTypeGuardAccess().getTypesTopTypesParserRuleCall_0_2_0()); 
	    }
		lv_types_2_0=ruleTopTypes		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTypeGuardRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getTypeGuardAccess().getRightParenthesisKeyword_0_3());
    }
)
    |((
(
		lv_name_4_0=RULE_VARIABLE
		{
			newLeafNode(lv_name_4_0, grammarAccess.getTypeGuardAccess().getNameVARIABLETerminalRuleCall_1_0_0()); 
		}
		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getTypeGuardAccess().getColonColonKeyword_1_1());
    }
(
(
		{ 
...
(
		...
		{ 
	        newCompositeNode(grammarAccess.getTypeAccess().getMModuleCrossReference_1_1_0_0()); 
	    }
		ruleName		{ 
	        afterParserOrEnumRuleCall();
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getTypeAccess().getArgsTopTypesParserRuleCall_1_3_1_0()); 
	    }
		lv_args_8_0=ruleTopTypes		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTypeRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_9, grammarAccess.getTypeAccess().getRightParenthesisKeyword_1_3_2());
    }
)?)
    |(
(
		lv_name_10_0=RULE_VARIABLE
		{
			newLeafNode(lv_name_10_0, grammarAccess.getTypeAccess().getNameVARIABLETerminalRuleCall_2_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getTypeRule());
...
(
    ...
    |(	otherlv_12='[' 
    {
    	newLeafNode(otherlv_12, grammarAccess.getTypeAccess().getLeftSquareBracketKeyword_4_0());
    }
(
    {
        $current = forceCreateModelElement(
...
(
    ...
    {
    	newLeafNode(otherlv_15, grammarAccess.getTypeAccess().getCommaKeyword_4_2_1_0());
    }
	otherlv_16='...' 
    {
    	newLeafNode(otherlv_16, grammarAccess.getTypeAccess().getFullStopFullStopFullStopKeyword_4_2_1_1());
    }
)?)?	otherlv_17=']' 
    {
    	newLeafNode(otherlv_17, grammarAccess.getTypeAccess().getRightSquareBracketKeyword_4_3());
    }
)
    |(	otherlv_18='{' 
    {
    	newLeafNode(otherlv_18, grammarAccess.getTypeAccess().getLeftCurlyBracketKeyword_5_0());
    }
(
    {
        $current = forceCreateModelElement(
...
(
		{ 
	        newCompositeNode(grammarAccess.getTypeAccess().getTypesTopTypesParserRuleCall_5_2_0()); 
	    }
		lv_types_20_0=ruleTopTypes		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTypeRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_21, grammarAccess.getTypeAccess().getRightCurlyBracketKeyword_5_3());
    }
)
    |(	otherlv_22='#' 
    {
    	newLeafNode(otherlv_22, grammarAccess.getTypeAccess().getNumberSignKeyword_6_0());
    }
(
    {
        $current = forceCreateModelElement(
...
(
    ...
    {
    	newLeafNode(otherlv_25, grammarAccess.getTypeAccess().getLeftCurlyBracketKeyword_6_3());
    }
((
(
		{ 
    ...
    {
    	newLeafNode(otherlv_27, grammarAccess.getTypeAccess().getCommaKeyword_6_4_1_0());
    }
(
(
		{ 
    ...
    {
    	newLeafNode(otherlv_29, grammarAccess.getTypeAccess().getRightCurlyBracketKeyword_6_5());
    }
)
    |
    { 
    ...
    this_BinaryType_30=ruleBinaryType
    { 
        $current = $this_BinaryType_30.current; 
        afterParserOrEnumRuleCall();
    }

    |(	otherlv_31='fun' 
    {
    	newLeafNode(otherlv_31, grammarAccess.getTypeAccess().getFunKeyword_8_0());
    }
(
    {
        $current = forceCreateModelElement(
    ...
    {
    	newLeafNode(otherlv_33, grammarAccess.getTypeAccess().getLeftParenthesisKeyword_8_2());
    }
(
(
		{ 
    ...
    {
    	newLeafNode(otherlv_35, grammarAccess.getTypeAccess().getRightParenthesisKeyword_8_4());
    }
))
;
...
(
		{ 
	        newCompositeNode(grammarAccess.getFunType100Access().getItemsTopTypesParserRuleCall_2_1_0()); 
	    }
		lv_items_3_0=ruleTopTypes		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getFunType100Access().getRightParenthesisKeyword_3());
    }
	otherlv_5='->' 
    {
    	newLeafNode(otherlv_5, grammarAccess.getFunType100Access().getHyphenMinusGreaterThanSignKeyword_4());
    }
(
(
		{ 
...
RULE_ATOM : (RULE_ATOMSTARTER RULE_INWORDCHAR*|'\'' ('\\' RULE_ESCAPE|~(('\\'|'\'')))* ('\''|EOF));

RULE_STRING : '"' ('\\' RULE_ESCAPE|~(('\\'|'"')))* ('"'|EOF);

RULE_VARIABLE : ('A'..'Z'|'_') RULE_INWORDCHAR*;
...
fragment RULE_INWORDCHAR : ('a'..'z'|'A'..'Z'|'_'|'@'|'0'..'9'|'\u00DF'..'\u00F6'|'\u00F8'..'\u00FF'|'\u00C0'..'\u00D6'|'\u00D8'..'\u00DE');

fragment RULE_ATOMSTARTER : ('a'..'z'|'\u00DF'..'\u00F6'|'\u00F8'..'\u00FF');

fragment RULE_ESCAPE : ('b'|'d'|'e'|'f'|'n'|'r'|'s'|'t'|'v'|'0'..'7' ('0'..'7' ('0'..'7')?)?|('x'|'X') RULE_HEXDIGIT RULE_HEXDIGIT|('x'|'X') '{' RULE_HEXDIGIT+ '}'|'^' ('a'..'z'|'A'..'Z'|']')|.);
