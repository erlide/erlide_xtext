...
public class ErlangGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class DefineAttributeElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cMacroNameAtomOrVarParserRuleCall_3_0 = (RuleCall)cMacroNameAssignment_3.eContents().get(0);
		...
		//
		//	AtomOrVar ("(" (args+=PatternExpression ("," args+=PatternExpression)*)? ")")? ("," value=Guard?)? ")" FULL_STOP;
		public ParserRule getRule() { return rule; }
		...
		//
		//AtomOrVar
		public RuleCall getMacroNameAtomOrVarParserRuleCall_3_0() { return cMacroNameAtomOrVarParserRuleCall_3_0; }
	...
	public class UndefAttributeElements extends AbstractParserRuleElementFinder {
		...
		//UndefAttribute:
		//
		//	"-" => tag="undef" "(" ref=[DefineAttribute|AtomOrVar] ")" FULL_STOP;
		public ParserRule getRule() { return rule; }
