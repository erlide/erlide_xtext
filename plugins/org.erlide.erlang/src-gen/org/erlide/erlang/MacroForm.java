...
public interface MacroForm extends Form {
    ...
    /**
     * Sets the value of the '{@link org.erlide.erlang.MacroForm#getCall
     * <em>Call</em>}' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Call</em>' containment reference.
     * @see #getCall()
     * @generated
     */
