...
public interface ReceiveExpr extends Expression {
    ...
    /**
     * Returns the value of the '<em><b>After expr</b></em>' containment
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>After expr</em>' containment reference isn't
     * clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     ...
     * 
     * @param value
     *            the new value of the '<em>After expr</em>' containment
     *            reference.
     * @see #getAfter_expr()
     * @generated
     */
