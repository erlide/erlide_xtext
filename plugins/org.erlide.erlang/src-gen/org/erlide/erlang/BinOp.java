...
public interface BinOp extends Expression
{
  ...
  /**
   * Sets the value of the '{@link org.erlide.erlang.BinOp#getOpLeft <em>Op Left</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link org.erlide.erlang.BinOp#getOp <em>Op</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link org.erlide.erlang.BinOp#getOpRight <em>Op Right</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the value of the '<em><b>Op Right2</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Op Right2</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link org.erlide.erlang.BinOp#getOpRight2 <em>Op Right2</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Op Right2</em>' containment reference.
   * @see #getOpRight2()
   * @generated
   */
