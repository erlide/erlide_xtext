 ...
 * <em><b>Record Tuple</b></em>'. <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class RecordTupleImpl extends MinimalEObjectImpl.Container implements
        RecordTuple {
    /**
    ...
    public EList<RecordFieldExpr> getFields() {
        if (fields == null) {
            fields = new EObjectContainmentEList<RecordFieldExpr>(
                    RecordFieldExpr.class, this,
                    ErlangPackage.RECORD_TUPLE__FIELDS);
        }
        return fields;
    }
    ...
    public void eSet(final int featureID, final Object newValue) {
        ...
        case ErlangPackage.RECORD_TUPLE__FIELDS:
            getFields().clear();
            getFields()
                    .addAll((Collection<? extends RecordFieldExpr>) newValue);
            return;
        }
