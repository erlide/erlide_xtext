 ...
 * <em><b>Atom Ref</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class AtomRefImpl extends ExpressionImpl implements AtomRef {
            ...
            if (value != oldValue) {
                if (eNotificationRequired()) {
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ErlangPackage.ATOM_REF__VALUE, oldValue, value));
                }
            }
        }
        return value;
     ...
     */
    @Override
    public void setValue(final AtomRefTarget newValue) {
        final AtomRefTarget oldValue = value;
        value = newValue;
        if (eNotificationRequired()) {
