 ...
 * <em><b>Cr Clause</b></em>'. <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class CrClauseImpl extends MinimalEObjectImpl.Container implements
        CrClause {
    /**
    ...
    public NotificationChain basicSetExpr(final Expression newExpr,
        ...
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.CR_CLAUSE__EXPR, oldExpr,
                    newExpr);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newExpr != expr) {
            ...
            if (expr != null) {
                msgs = ((InternalEObject) expr).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ErlangPackage.CR_CLAUSE__EXPR,
                        null, msgs);
            }
            if (newExpr != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.CR_CLAUSE__EXPR, newExpr, newExpr));
        }
    }
    ...
    public NotificationChain basicSetGuard(final Guard newGuard,
        ...
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.CR_CLAUSE__GUARD, oldGuard,
                    newGuard);
            if (msgs == null) {
                msgs = notification;
            } else {
    ...
    public void setGuard(final Guard newGuard) {
        if (newGuard != guard) {
            ...
            if (guard != null) {
                msgs = ((InternalEObject) guard)
                        .eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.CR_CLAUSE__GUARD, null, msgs);
            }
            if (newGuard != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.CR_CLAUSE__GUARD, newGuard, newGuard));
        }
    }
    ...
    public NotificationChain basicSetBody(final Expressions newBody,
        ...
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.CR_CLAUSE__BODY, oldBody,
                    newBody);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newBody != body) {
            ...
            if (body != null) {
                msgs = ((InternalEObject) body).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ErlangPackage.CR_CLAUSE__BODY,
                        null, msgs);
            }
            if (newBody != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.CR_CLAUSE__BODY, newBody, newBody));
        }
    }
