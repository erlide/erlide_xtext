...
public class BinOpImpl extends ExpressionImpl implements BinOp {
    ...
    /**
     * The cached value of the '{@link #getOpRight2() <em>Op Right2</em>}'
     * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getOpRight2()
     * @generated
    ...
    public NotificationChain basicSetOpLeft(final Expression newOpLeft,
        ...
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.BIN_OP__OP_LEFT, oldOpLeft,
                    newOpLeft);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newOpLeft != opLeft) {
            ...
            if (opLeft != null) {
                msgs = ((InternalEObject) opLeft).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ErlangPackage.BIN_OP__OP_LEFT,
                        null, msgs);
            }
            if (newOpLeft != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.BIN_OP__OP_LEFT, newOpLeft, newOpLeft));
        }
    }
    ...
    public void setOp(final String newOp) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.BIN_OP__OP, oldOp, op));
        }
    }
    ...
    public NotificationChain basicSetOpRight(final Expression newOpRight,
        ...
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.BIN_OP__OP_RIGHT,
    ...
    public void setOpRight(final Expression newOpRight) {
        if (newOpRight != opRight) {
            ...
            if (opRight != null) {
                msgs = ((InternalEObject) opRight)
                        .eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.BIN_OP__OP_RIGHT, null, msgs);
            }
            if (newOpRight != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.BIN_OP__OP_RIGHT, newOpRight, newOpRight));
        }
    }
     ...
     * @generated
     */
    public NotificationChain basicSetOpRight2(final Expression newOpRight2,
            NotificationChain msgs) {
        final Expression oldOpRight2 = opRight2;
        opRight2 = newOpRight2;
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.BIN_OP__OP_RIGHT2,
                    oldOpRight2, newOpRight2);
            if (msgs == null) {
                msgs = notification;
            } else {
                msgs.add(notification);
     ...
     */
    @Override
    public void setOpRight2(final Expression newOpRight2) {
        if (newOpRight2 != opRight2) {
            NotificationChain msgs = null;
            if (opRight2 != null) {
                msgs = ((InternalEObject) opRight2).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.BIN_OP__OP_RIGHT2, null, msgs);
            }
            if (newOpRight2 != null) {
                msgs = ((InternalEObject) newOpRight2).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.BIN_OP__OP_RIGHT2, null, msgs);
            }
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.BIN_OP__OP_RIGHT2, newOpRight2, newOpRight2));
        }
    }
