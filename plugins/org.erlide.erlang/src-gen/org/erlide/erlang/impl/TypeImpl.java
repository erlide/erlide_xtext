...
public class TypeImpl extends Type500Impl implements Type {
    ...
    public NotificationChain basicSetTypeName(final Expression newTypeName,
        ...
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.TYPE__TYPE_NAME,
        ...
        if (newTypeName != typeName) {
            ...
            if (typeName != null) {
                msgs = ((InternalEObject) typeName).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ErlangPackage.TYPE__TYPE_NAME,
                        null, msgs);
            }
            if (newTypeName != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.TYPE__TYPE_NAME, newTypeName, newTypeName));
        }
    }
    ...
    public void setValue(final String newValue) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.TYPE__VALUE, oldValue, value));
        }
    }
