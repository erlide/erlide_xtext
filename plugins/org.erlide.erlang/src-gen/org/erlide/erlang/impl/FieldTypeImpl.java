 ...
 * <ul>
 *   <li>{@link org.erlide.erlang.impl.FieldTypeImpl#getName <em>Name</em>}</li>
...
public class FieldTypeImpl extends MinimalEObjectImpl.Container implements FieldType
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ErlangPackage.FIELD_TYPE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ErlangPackage.FIELD_TYPE__NAME:
        return getName();
      case ErlangPackage.FIELD_TYPE__TYPE:
        return getType();
    }
