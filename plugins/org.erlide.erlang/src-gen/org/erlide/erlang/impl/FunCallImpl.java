...
public class FunCallImpl extends ExpressionImpl implements FunCall
{
  ...
  /**
   * The cached value of the '{@link #getArgs2() <em>Args2</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getArgs2()
   * @generated
  ...
  public NotificationChain basicSetArgs(Expressions newArgs, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ErlangPackage.FUN_CALL__ARGS, oldArgs, newArgs);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setArgs(Expressions newArgs)
  {
    if (newArgs != args)
    {
      NotificationChain msgs = null;
      if (args != null)
        msgs = ((InternalEObject)args).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ErlangPackage.FUN_CALL__ARGS, null, msgs);
      if (newArgs != null)
        msgs = ((InternalEObject)newArgs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ErlangPackage.FUN_CALL__ARGS, null, msgs);
      msgs = basicSetArgs(newArgs, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ErlangPackage.FUN_CALL__ARGS, newArgs, newArgs));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetArgs2(Expressions newArgs2, NotificationChain msgs)
  {
    Expressions oldArgs2 = args2;
    args2 = newArgs2;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ErlangPackage.FUN_CALL__ARGS2, oldArgs2, newArgs2);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
   ...
   * @generated
   */
  public void setArgs2(Expressions newArgs2)
  {
    if (newArgs2 != args2)
    {
      NotificationChain msgs = null;
      if (args2 != null)
        msgs = ((InternalEObject)args2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ErlangPackage.FUN_CALL__ARGS2, null, msgs);
      if (newArgs2 != null)
        msgs = ((InternalEObject)newArgs2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ErlangPackage.FUN_CALL__ARGS2, null, msgs);
      msgs = basicSetArgs2(newArgs2, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ErlangPackage.FUN_CALL__ARGS2, newArgs2, newArgs2));
  }
