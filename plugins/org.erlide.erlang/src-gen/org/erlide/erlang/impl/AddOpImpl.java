...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Add Op</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class AddOpImpl extends ExpressionImpl implements AddOp
{
  ...
  public NotificationChain basicSetOpLeft(Expression newOpLeft, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ErlangPackage.ADD_OP__OP_LEFT, oldOpLeft, newOpLeft);
  ...
  public void setOpLeft(Expression newOpLeft)
  {
    if (newOpLeft != opLeft)
    {
      ...
      if (opLeft != null)
        msgs = ((InternalEObject)opLeft).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ErlangPackage.ADD_OP__OP_LEFT, null, msgs);
      if (newOpLeft != null)
        msgs = ((InternalEObject)newOpLeft).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ErlangPackage.ADD_OP__OP_LEFT, null, msgs);
      msgs = basicSetOpLeft(newOpLeft, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ErlangPackage.ADD_OP__OP_LEFT, newOpLeft, newOpLeft));
  }
  ...
  public void setOp(String newOp)
  {
    ...
    op = newOp;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ErlangPackage.ADD_OP__OP, oldOp, op));
  }
  ...
  public NotificationChain basicSetOpRight(Expression newOpRight, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ErlangPackage.ADD_OP__OP_RIGHT, oldOpRight, newOpRight);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setOpRight(Expression newOpRight)
  {
    if (newOpRight != opRight)
    {
      NotificationChain msgs = null;
      if (opRight != null)
        msgs = ((InternalEObject)opRight).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ErlangPackage.ADD_OP__OP_RIGHT, null, msgs);
      if (newOpRight != null)
        msgs = ((InternalEObject)newOpRight).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ErlangPackage.ADD_OP__OP_RIGHT, null, msgs);
      msgs = basicSetOpRight(newOpRight, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ErlangPackage.ADD_OP__OP_RIGHT, newOpRight, newOpRight));
  }
