 ...
 * <em><b>Record Field Def</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.erlide.erlang.impl.RecordFieldDefImpl#getName <em>Name</em>}</li>
 * <li>{@link org.erlide.erlang.impl.RecordFieldDefImpl#getValue <em>Value</em>}
 * </li>
 ...
 * @generated
 */
public class RecordFieldDefImpl extends AtomRefTargetImpl implements
        RecordFieldDef {
    /**
    ...
    public void setName(final String newName) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.RECORD_FIELD_DEF__NAME, oldName, name));
        }
    }
    ...
    public NotificationChain basicSetValue(final Expression newValue,
        ...
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.RECORD_FIELD_DEF__VALUE,
                    oldValue, newValue);
            if (msgs == null) {
                msgs = notification;
            } else {
    ...
    public void setValue(final Expression newValue) {
        if (newValue != value) {
            ...
            if (value != null) {
                msgs = ((InternalEObject) value).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.RECORD_FIELD_DEF__VALUE, null,
                        msgs);
            }
            if (newValue != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.RECORD_FIELD_DEF__VALUE, newValue, newValue));
        }
    }
    ...
    public NotificationChain basicSetType(final TopType newType,
        ...
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.RECORD_FIELD_DEF__TYPE,
                    oldType, newType);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newType != type) {
            ...
            if (type != null) {
                msgs = ((InternalEObject) type).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.RECORD_FIELD_DEF__TYPE, null,
                        msgs);
            }
            if (newType != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.RECORD_FIELD_DEF__TYPE, newType, newType));
        }
    }
