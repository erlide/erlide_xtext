 ...
 * <em><b>Spec Attribute</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.erlide.erlang.impl.SpecAttributeImpl#getRef <em>Ref</em>}</li>
 * <li>{@link org.erlide.erlang.impl.SpecAttributeImpl#getSignatures <em>
 * Signatures</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpecAttributeImpl extends AbstractTypeAttributeImpl implements
        SpecAttribute {
    /**
     ...
     * @generated
     */
    public NotificationChain basicSetRef(final FunRef newRef,
            NotificationChain msgs) {
        final FunRef oldRef = ref;
        ref = newRef;
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.SPEC_ATTRIBUTE__REF,
                    oldRef, newRef);
            if (msgs == null) {
                msgs = notification;
            } else {
     ...
     */
    @Override
    public void setRef(final FunRef newRef) {
        if (newRef != ref) {
            NotificationChain msgs = null;
            if (ref != null) {
                msgs = ((InternalEObject) ref)
                        .eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.SPEC_ATTRIBUTE__REF, null, msgs);
            }
            if (newRef != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.SPEC_ATTRIBUTE__REF, newRef, newRef));
        }
    }
    ...
    public EList<TypeSig> getSignatures() {
        if (signatures == null) {
            signatures = new EObjectContainmentEList<TypeSig>(TypeSig.class,
                    this, ErlangPackage.SPEC_ATTRIBUTE__SIGNATURES);
        }
        return signatures;
    }
    ...
    public NotificationChain eInverseRemove(final InternalEObject otherEnd,
        ...
        case ErlangPackage.SPEC_ATTRIBUTE__SIGNATURES:
            return ((InternalEList<?>) getSignatures()).basicRemove(otherEnd,
                    msgs);
        }
