 ...
 * <em><b>Bin Unit Type</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.erlide.erlang.impl.BinUnitTypeImpl#getTypeName <em>Type Name
 * </em>}</li>
 ...
 * @generated
 */
public class BinUnitTypeImpl extends MinimalEObjectImpl.Container implements
        BinUnitType {
    /**
    ...
    protected EClass eStaticClass() {
        return ErlangPackage.Literals.BIN_UNIT_TYPE;
    }
    ...
    public NotificationChain basicSetTypeName(final Expression newTypeName,
        ...
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.BIN_UNIT_TYPE__TYPE_NAME,
    ...
    public void setTypeName(final Expression newTypeName) {
        if (newTypeName != typeName) {
            ...
            if (typeName != null) {
                msgs = ((InternalEObject) typeName).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.BIN_UNIT_TYPE__TYPE_NAME, null,
                        msgs);
            }
            if (newTypeName != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.BIN_UNIT_TYPE__TYPE_NAME, newTypeName,
                    newTypeName));
        }
    }
     ...
     */
    @Override
    public void setM(final String newM) {
        final String oldM = m;
        m = newM;
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.BIN_UNIT_TYPE__M, oldM, m));
        }
    }
     ...
     * @generated
     */
    public NotificationChain basicSetType(final Type newType,
            NotificationChain msgs) {
        final Type oldType = type;
        type = newType;
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.BIN_UNIT_TYPE__TYPE,
                    oldType, newType);
            if (msgs == null) {
                msgs = notification;
            } else {
    ...
    public void setType(final Type newType) {
        if (newType != type) {
            ...
            if (type != null) {
                msgs = ((InternalEObject) type)
                        .eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.BIN_UNIT_TYPE__TYPE, null, msgs);
            }
            if (newType != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.BIN_UNIT_TYPE__TYPE, newType, newType));
        }
    }
