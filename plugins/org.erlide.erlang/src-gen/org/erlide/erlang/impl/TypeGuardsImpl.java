 ...
 * @generated
 */
public class TypeGuardsImpl extends MinimalEObjectImpl.Container implements
        TypeGuards {
    /**
    ...
    public EList<TypeGuard> getItems() {
        if (items == null) {
            items = new EObjectContainmentEList<TypeGuard>(TypeGuard.class,
                    this, ErlangPackage.TYPE_GUARDS__ITEMS);
        }
        return items;
    }
