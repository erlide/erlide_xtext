 ...
 * <em><b>Record Field Expr</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.erlide.erlang.impl.RecordFieldExprImpl#getRef <em>Ref</em>}</li>
 * <li>{@link org.erlide.erlang.impl.RecordFieldExprImpl#getValue <em>Value
 * </em>}</li>
 ...
 * @generated
 */
public class RecordFieldExprImpl extends MinimalEObjectImpl.Container implements
        RecordFieldExpr {
    /**
    ...
    public NotificationChain basicSetRef(final Expression newRef,
        ...
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.RECORD_FIELD_EXPR__REF,
                    oldRef, newRef);
            if (msgs == null) {
                msgs = notification;
            } else {
    ...
    public void setRef(final Expression newRef) {
        if (newRef != ref) {
            ...
            if (ref != null) {
                msgs = ((InternalEObject) ref).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.RECORD_FIELD_EXPR__REF, null,
                        msgs);
            }
            if (newRef != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.RECORD_FIELD_EXPR__REF, newRef, newRef));
        }
    }
     ...
     * @generated
     */
    public NotificationChain basicSetValue(final Expression newValue,
            NotificationChain msgs) {
        final Expression oldValue = value;
        value = newValue;
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.RECORD_FIELD_EXPR__VALUE,
                    oldValue, newValue);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newValue != value) {
            ...
            if (value != null) {
                msgs = ((InternalEObject) value).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.RECORD_FIELD_EXPR__VALUE, null,
                        msgs);
            }
            if (newValue != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.RECORD_FIELD_EXPR__VALUE, newValue, newValue));
        }
    }
    ...
    public NotificationChain basicSetType(final TopType newType,
        ...
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.RECORD_FIELD_EXPR__TYPE,
                    oldType, newType);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newType != type) {
            ...
            if (type != null) {
                msgs = ((InternalEObject) type).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.RECORD_FIELD_EXPR__TYPE, null,
                        msgs);
            }
            if (newType != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.RECORD_FIELD_EXPR__TYPE, newType, newType));
        }
    }
