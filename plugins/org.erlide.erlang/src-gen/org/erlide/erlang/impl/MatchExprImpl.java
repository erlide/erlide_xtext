 ...
 * <li>{@link org.erlide.erlang.impl.MatchExprImpl#getOpRight <em>Op Right</em>}
 * </li>
 * </ul>
 *
 * @generated
...
public class MatchExprImpl extends ExpressionImpl implements MatchExpr {
    ...
    public NotificationChain basicSetOpLeft(final Expression newOpLeft,
        ...
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.MATCH_EXPR__OP_LEFT,
                    oldOpLeft, newOpLeft);
            if (msgs == null) {
                msgs = notification;
            } else {
    ...
    public void setOpLeft(final Expression newOpLeft) {
        if (newOpLeft != opLeft) {
            ...
            if (opLeft != null) {
                msgs = ((InternalEObject) opLeft)
                        .eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.MATCH_EXPR__OP_LEFT, null, msgs);
            }
            if (newOpLeft != null) {
                msgs = ((InternalEObject) newOpLeft)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.MATCH_EXPR__OP_LEFT, newOpLeft, newOpLeft));
        }
    }
    ...
    public void setOp(final String newOp) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.MATCH_EXPR__OP, oldOp, op));
        }
    }
    ...
    public NotificationChain basicSetOpRight(final Expression newOpRight,
        ...
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.MATCH_EXPR__OP_RIGHT,
    ...
    public void setOpRight(final Expression newOpRight) {
        if (newOpRight != opRight) {
            NotificationChain msgs = null;
            if (opRight != null) {
                msgs = ((InternalEObject) opRight).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.MATCH_EXPR__OP_RIGHT, null,
                        msgs);
            }
            if (newOpRight != null) {
                msgs = ((InternalEObject) newOpRight).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.MATCH_EXPR__OP_RIGHT, null,
                        msgs);
            }
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.MATCH_EXPR__OP_RIGHT, newOpRight, newOpRight));
        }
    }
