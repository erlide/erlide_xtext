 ...
 * <em><b>Ifdef Attribute</b></em>'. <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class IfdefAttributeImpl extends ConditionalAttributeImpl implements
        IfdefAttribute {
    /**
    ...
    public NotificationChain basicSetRef(final Expression newRef,
        ...
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.IFDEF_ATTRIBUTE__REF,
                    oldRef, newRef);
            if (msgs == null) {
                msgs = notification;
            } else {
    ...
    public void setRef(final Expression newRef) {
        if (newRef != ref) {
            ...
            if (ref != null) {
                msgs = ((InternalEObject) ref).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.IFDEF_ATTRIBUTE__REF, null,
                        msgs);
            }
            if (newRef != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.IFDEF_ATTRIBUTE__REF, newRef, newRef));
        }
    }
