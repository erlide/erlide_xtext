 ...
 * <em><b>Compile Attribute</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.erlide.erlang.impl.CompileAttributeImpl#getOptions <em>Options
 * </em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompileAttributeImpl extends AttributeImpl implements
        CompileAttribute {
    /**
     ...
     * @generated
     */
    public NotificationChain basicSetOptions(final Expression newOptions,
            NotificationChain msgs) {
        final Expression oldOptions = options;
        options = newOptions;
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.COMPILE_ATTRIBUTE__OPTIONS,
     ...
     */
    @Override
    public void setOptions(final Expression newOptions) {
        if (newOptions != options) {
            NotificationChain msgs = null;
            if (options != null) {
                msgs = ((InternalEObject) options).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.COMPILE_ATTRIBUTE__OPTIONS,
                        null, msgs);
            }
            if (newOptions != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.COMPILE_ATTRIBUTE__OPTIONS, newOptions,
                    newOptions));
        }
    }
