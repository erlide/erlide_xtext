...
public class UnaryExprImpl extends ExpressionImpl implements UnaryExpr
{
  ...
  public void setOp(String newOp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ErlangPackage.UNARY_EXPR__OP, oldOp, op));
  }
  ...
  public NotificationChain basicSetOperand(Expression newOperand, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ErlangPackage.UNARY_EXPR__OPERAND, oldOperand, newOperand);
  ...
  public void setOperand(Expression newOperand)
  {
    if (newOperand != operand)
    {
      ...
      if (operand != null)
        msgs = ((InternalEObject)operand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ErlangPackage.UNARY_EXPR__OPERAND, null, msgs);
      if (newOperand != null)
        msgs = ((InternalEObject)newOperand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ErlangPackage.UNARY_EXPR__OPERAND, null, msgs);
      msgs = basicSetOperand(newOperand, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ErlangPackage.UNARY_EXPR__OPERAND, newOperand, newOperand));
  }
