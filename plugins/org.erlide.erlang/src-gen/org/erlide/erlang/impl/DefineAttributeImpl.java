 ...
 * <em><b>Define Attribute</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.erlide.erlang.impl.DefineAttributeImpl#getMacroName <em>Macro
 * Name</em>}</li>
 * <li>{@link org.erlide.erlang.impl.DefineAttributeImpl#getArgs <em>Args</em>}</li>
 * <li>{@link org.erlide.erlang.impl.DefineAttributeImpl#getValue <em>Value
 * </em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefineAttributeImpl extends AbstractDefineAttributeImpl implements
        DefineAttribute {
    /**
     * The default value of the '{@link #getMacroName() <em>Macro Name</em>}'
     ...
     */
    @Override
    public void setMacroName(final String newMacroName) {
        final String oldMacroName = macroName;
        macroName = newMacroName;
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.DEFINE_ATTRIBUTE__MACRO_NAME, oldMacroName,
                    macroName));
        }
    }
    ...
    public EList<Expression> getArgs() {
        if (args == null) {
            args = new EObjectContainmentEList<Expression>(Expression.class,
                    this, ErlangPackage.DEFINE_ATTRIBUTE__ARGS);
        }
        return args;
    }
     ...
     * @generated
     */
    public NotificationChain basicSetValue(final Guard newValue,
            NotificationChain msgs) {
        final Guard oldValue = value;
        value = newValue;
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.DEFINE_ATTRIBUTE__VALUE,
                    oldValue, newValue);
            if (msgs == null) {
                msgs = notification;
            } else {
     ...
     */
    @Override
    public void setValue(final Guard newValue) {
        if (newValue != value) {
            NotificationChain msgs = null;
            if (value != null) {
                msgs = ((InternalEObject) value).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.DEFINE_ATTRIBUTE__VALUE, null,
                        msgs);
            }
            if (newValue != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.DEFINE_ATTRIBUTE__VALUE, newValue, newValue));
        }
    }
    ...
    public boolean eIsSet(final int featureID) {
        switch (featureID) {
        case ErlangPackage.DEFINE_ATTRIBUTE__MACRO_NAME:
            return MACRO_NAME_EDEFAULT == null ? macroName != null
                    : !MACRO_NAME_EDEFAULT.equals(macroName);
        case ErlangPackage.DEFINE_ATTRIBUTE__ARGS:
