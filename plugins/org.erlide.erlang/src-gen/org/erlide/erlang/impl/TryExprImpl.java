 ...
 * <em><b>Try Expr</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.erlide.erlang.impl.TryExprImpl#getBody <em>Body</em>}</li>
 * <li>{@link org.erlide.erlang.impl.TryExprImpl#getOf_clauses <em>Of clauses
 * </em>}</li>
 * <li>{@link org.erlide.erlang.impl.TryExprImpl#getCatch <em>Catch</em>}</li>
 * <li>{@link org.erlide.erlang.impl.TryExprImpl#getAfter_body <em>After body
 * </em>}</li>
 * </ul>
 *
 * @generated
...
public class TryExprImpl extends ExpressionImpl implements TryExpr {
    ...
    /**
     * The cached value of the '{@link #getOf_clauses() <em>Of clauses</em>}'
    ...
    /**
     * The cached value of the '{@link #getCatch() <em>Catch</em>}' containment
    ...
    public NotificationChain basicSetBody(final Expressions newBody,
        ...
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.TRY_EXPR__BODY, oldBody,
                    newBody);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newBody != body) {
            ...
            if (body != null) {
                msgs = ((InternalEObject) body).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ErlangPackage.TRY_EXPR__BODY,
                        null, msgs);
            }
            if (newBody != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.TRY_EXPR__BODY, newBody, newBody));
        }
    }
    ...
    public EList<CrClause> getOf_clauses() {
        if (of_clauses == null) {
            of_clauses = new EObjectContainmentEList<CrClause>(CrClause.class,
                    this, ErlangPackage.TRY_EXPR__OF_CLAUSES);
        }
        return of_clauses;
    }
    ...
    public EList<TryClause> getCatch() {
        if (catch_ == null) {
            catch_ = new EObjectContainmentEList<TryClause>(TryClause.class,
                    this, ErlangPackage.TRY_EXPR__CATCH);
        }
        return catch_;
    }
    ...
    public NotificationChain basicSetAfter_body(
        ...
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.TRY_EXPR__AFTER_BODY,
    ...
    public void setAfter_body(final Expressions newAfter_body) {
        if (newAfter_body != after_body) {
            ...
            if (after_body != null) {
                msgs = ((InternalEObject) after_body).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.TRY_EXPR__AFTER_BODY, null,
                        msgs);
            }
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.TRY_EXPR__AFTER_BODY, newAfter_body,
                    newAfter_body));
        }
    }
    ...
    public NotificationChain eInverseRemove(final InternalEObject otherEnd,
        ...
        case ErlangPackage.TRY_EXPR__OF_CLAUSES:
            return ((InternalEList<?>) getOf_clauses()).basicRemove(otherEnd,
                    msgs);
