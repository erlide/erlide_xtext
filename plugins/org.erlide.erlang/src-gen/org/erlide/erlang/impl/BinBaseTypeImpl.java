 ...
 * </p>
 * <ul>
 * <li>{@link org.erlide.erlang.impl.BinBaseTypeImpl#getTypeName <em>Type Name
 * </em>}</li>
 ...
 * @generated
 */
public class BinBaseTypeImpl extends MinimalEObjectImpl.Container implements
        BinBaseType {
    /**
    ...
    public NotificationChain basicSetTypeName(final Expression newTypeName,
        ...
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.BIN_BASE_TYPE__TYPE_NAME,
    ...
    public void setTypeName(final Expression newTypeName) {
        if (newTypeName != typeName) {
            ...
            if (typeName != null) {
                msgs = ((InternalEObject) typeName).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.BIN_BASE_TYPE__TYPE_NAME, null,
                        msgs);
            }
            if (newTypeName != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.BIN_BASE_TYPE__TYPE_NAME, newTypeName,
                    newTypeName));
        }
    }
    ...
    public NotificationChain basicSetType(final Type newType,
        ...
        if (eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET, ErlangPackage.BIN_BASE_TYPE__TYPE,
                    oldType, newType);
            if (msgs == null) {
                msgs = notification;
            } else {
    ...
    public void setType(final Type newType) {
        if (newType != type) {
            ...
            if (type != null) {
                msgs = ((InternalEObject) type)
                        .eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                                - ErlangPackage.BIN_BASE_TYPE__TYPE, null, msgs);
            }
            if (newType != null) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ErlangPackage.BIN_BASE_TYPE__TYPE, newType, newType));
        }
    }
