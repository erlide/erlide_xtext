...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Conditional Form Block</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link org.erlide.erlang.ConditionalFormBlock#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.erlide.erlang.ConditionalFormBlock#getIfForms <em>If Forms</em>}</li>
 *   <li>{@link org.erlide.erlang.ConditionalFormBlock#isHasElse <em>Has Else</em>}</li>
 *   <li>{@link org.erlide.erlang.ConditionalFormBlock#getElseForms <em>Else Forms</em>}</li>
...
public interface ConditionalFormBlock extends Form
{
  ...
  /**
   * Sets the value of the '{@link org.erlide.erlang.ConditionalFormBlock#getCondition <em>Condition</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the value of the '<em><b>If Forms</b></em>' containment reference list.
   * The list contents are of type {@link org.erlide.erlang.Form}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>If Forms</em>' containment reference list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link org.erlide.erlang.ConditionalFormBlock#isHasElse <em>Has Else</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the value of the '<em><b>Else Forms</b></em>' containment reference list.
   * The list contents are of type {@link org.erlide.erlang.Form}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Else Forms</em>' containment reference list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Else Forms</em>' containment reference list.
  ...
  /**
   * Sets the value of the '{@link org.erlide.erlang.ConditionalFormBlock#getEnd <em>End</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
