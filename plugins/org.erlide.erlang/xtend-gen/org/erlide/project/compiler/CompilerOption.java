...
public abstract class CompilerOption {
    public static BooleanOption COMPRESSED = new Function0<BooleanOption>() {
        public BooleanOption apply() {
            final BooleanOption _booleanOption = new BooleanOption(
                    "compressed",
                    false,
                    "Compress beam file",
    ...
    public static DefineOption DEFINE = new Function0<DefineOption>() {
        public DefineOption apply() {
            final ArrayList<String> _newArrayList = CollectionLiterals
                    .<String> newArrayList("Name", "Value");
            final DefineOption _defineOption = new DefineOption("d",
                    (String[]) Conversions.unwrapArray(_newArrayList,
                            String.class), "", "");
    ...
    public static WarningOption WARN_UNUSED_RECORD = new Function0<WarningOption>() {
        public WarningOption apply() {
            final WarningOption _warningOption = new WarningOption(
                    "warn_unused_record", true, "Unused records",
                    "Unused records");
    ...
    public static WarningOption WARN_UNUSED_VARS = new Function0<WarningOption>() {
        public WarningOption apply() {
            final WarningOption _warningOption = new WarningOption(
                    "warn_unused_vars", true, "Unused variables",
                    "Unused variables");
            return _warningOption;
        }
    }.apply();
    ...
    public static PathsOption INCLUDE_DIRS = new Function0<PathsOption>() {
        public PathsOption apply() {
            final PathsOption _pathsOption = new PathsOption("i",
    ...
    public static ModuleOption PARSE_TRANSFORM = new Function0<ModuleOption>() {
        public ModuleOption apply() {
            final ModuleOption _moduleOption = new ModuleOption(
    ...
    public static Collection<WarningOption> WARNINGS = new Function0<Collection<WarningOption>>() {
        public Collection<WarningOption> apply() {
            final ArrayList<WarningOption> _newArrayList = CollectionLiterals
                    .<WarningOption> newArrayList(
                            CompilerOption.WARN_EXPORT_ALL,
                            CompilerOption.WARN_EXPORT_VARS,
                            CompilerOption.WARN_SHADOW_VARS,
                            CompilerOption.WARN_UNUSED_FUNCTION,
                            CompilerOption.WARN_DEPRECATED_FUNCTION,
                            CompilerOption.WARN_OBSOLETE_GUARD,
                            CompilerOption.WARN_UNUSED_IMPORT,
                            CompilerOption.WARN_UNUSED_VARS,
    ...
    public static Collection<CompilerOption> ALL_OPTIONS = new Function0<Collection<CompilerOption>>() {
        public Collection<CompilerOption> apply() {
            final ArrayList<CompilerOption> _newArrayList = CollectionLiterals
                    .<CompilerOption> newArrayList(CompilerOption.INCLUDE_DIRS,
                            CompilerOption.PARSE_TRANSFORM,
                            CompilerOption.DEFINE, CompilerOption.COMPRESSED,
                            CompilerOption.DEBUG_INFO,
                            CompilerOption.ENCRYPT_DEBUG_INFO,
                            CompilerOption.WARN_EXPORT_ALL,
                            CompilerOption.WARN_EXPORT_VARS,
                            CompilerOption.WARN_SHADOW_VARS,
                            CompilerOption.WARN_UNUSED_FUNCTION,
    ...
    public CompilerOption(final String name, final String description,
    ...
    public static CompilerOption find(final String data) {
        for (final CompilerOption option : CompilerOption.ALL_OPTIONS) {
            final boolean _equals = data.equals(option.name);
            if (_equals) {
                return option;
            }
        }
        final String _plus = "Invalid value for compiler option: " + data;
        final IllegalArgumentException _illegalArgumentException = new IllegalArgumentException(
                _plus);
