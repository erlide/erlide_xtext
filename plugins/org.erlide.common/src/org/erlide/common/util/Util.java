...
public final class Util {
    ...
    private static final String BUNDLE_NAME = "org.erlide.common.util"; //$NON-NLS-1$
    ...
    private static void quickSort(final Comparable[] sortedCollection,
        ...
        do {
            ...
            if (left <= right) {
                final Comparable tmp = sortedCollection[left];
    ...
    private static void quickSort(final Object[] sortedCollection, int left,
        ...
        do {
            ...
            if (left <= right) {
                final Object tmp = sortedCollection[left];
                sortedCollection[left] = sortedCollection[right];
                sortedCollection[right] = tmp;
                left++;
                right--;
    ...
    private static void quickSort(final String[] sortedCollection, int left,
        ...
        do {
            ...
            if (left <= right) {
                final String tmp = sortedCollection[left];
                sortedCollection[left] = sortedCollection[right];
                sortedCollection[right] = tmp;
                left++;
                right--;
